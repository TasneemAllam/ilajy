...
var theSearchText=null;
function fg_popup_form(formdiv_id,container_id,bg_div_id,theSearchVal,placeVar)
{
    var e=placeVar;
	//var index = e.selectedIndex;
	//var ePlace=e.options[index].value;
	//alert(e);
	document.getElementById('hero-demo').value=theSearchVal;
	document.getElementById('placename').value=placeVar;
    ...
    formdiv.style.display="block";
     ...
     var pt = window.center({width:800,height:600});
	...
	fg_add_search(theSearchVal);

}
function fg_add_search(search_text)
{

             $(document).ready(function(){
				//alert(search_text);
				 var myData={"searchtext":search_text,"submitted":true};
				 //alert(myData);
				$.ajax({
					url : "search_tracking.php",
					type: "POST",
					data : myData,
