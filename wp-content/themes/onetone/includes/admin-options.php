...
function optionsframework_options() {
	...
	$onetone_option_args['theme_options'] = $theme_options;
	...
	$options[] = array(
		'name' => '',
		'desc' =>'<select id="section-id">'.$o_sections.'</select><a id="add-section" style=" margin-left:15px;" class="btn button-secondary">'.__('Add Section', 'onetone').'</a>',
		'id' => 'onetone_get_pro',
		'std' => '',
		'type' => 'info',
		'class'=>'section-item accordion-group-section-order'
